...
@dataclasses.dataclass
class BrowseByURLResponseDefaultResponseBody:
...
class BrowseByURLResponse:
    ...
    r"""Successful operation"""
    default_application_json_object: Optional[BrowseByURLResponseDefaultResponseBody] = dataclasses.field(default=None)
    r"""Error fetching search results"""
