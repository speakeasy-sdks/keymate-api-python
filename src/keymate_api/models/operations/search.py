...
@dataclasses.dataclass
class SearchResponseDefaultResponseBody:
...
class SearchResponseBody:
    ...
    results: Optional[List[SearchResults]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})
...
class SearchResponse:
    ...
    r"""Successful operation"""
    default_application_json_object: Optional[SearchResponseDefaultResponseBody] = dataclasses.field(default=None)
    r"""Error fetching search results"""
